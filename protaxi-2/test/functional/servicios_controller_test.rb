...
class ServiciosControllerTest < ActionController::TestCase
  ...
  test "should create servicio" do
    assert_difference('Servicio.count') do
      post :create, servicio: { direcciondestino: @servicio.direcciondestino, direccionorigen: @servicio.direccionorigen, fechaservicio: @servicio.fechaservicio, horaservicio: @servicio.horaservicio, pasajeros: @servicio.pasajeros }
    end
  ...
  test "should update servicio" do
    put :update, id: @servicio, servicio: { direcciondestino: @servicio.direcciondestino, direccionorigen: @servicio.direccionorigen, fechaservicio: @servicio.fechaservicio, horaservicio: @servicio.horaservicio, pasajeros: @servicio.pasajeros }
    assert_redirected_to servicio_path(assigns(:servicio))
  end
